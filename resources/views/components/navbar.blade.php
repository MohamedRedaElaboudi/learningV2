  ...
  <header class="bg-white dark:bg-gray-900 shadow-md">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <div class="flex items-center space-x-6">
        <nav class="space-x-6 text-gray-900 dark:text-white font-medium">
          <a href="{{ route('Acceuil') }}" class="hover:text-blue-600 dark:hover:text-blue-400">Accueil</a>
          <a href="#" class="hover:text-blue-600 dark:hover:text-blue-400">Cours</a>
          <a href="#" class="hover:text-blue-600 dark:hover:text-blue-400">À propos</a>
          <a href="{{ route('login.show') }}" class="hover:text-blue-600 dark:hover:text-blue-400">Se connecter</a>
        </nav>
